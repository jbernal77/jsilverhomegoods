...
if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
    header("location: https://bernal.myweb.cs.uwindsor.ca/jsilverhomegoods/welcome.php");
    exit;
}
...
<body>
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Don't have an account? <a href="https://bernal.myweb.cs.uwindsor.ca/jsilverhomegoods/signup.php">Sign up now</a>.</p>
        </form>
    </div>
</body>
</html>