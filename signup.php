...
<head>
    ...
    <meta name="description" content="JSilverHomegoods Sign Up">   
    <meta name="keywords" content="JSilverHomegoods SignUp LogIn CreateAccount Create Account">
...
<body>
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Already have an account? <a href="https://bernal.myweb.cs.uwindsor.ca/jsilverhomegoods/login.php">Login here</a>.</p>
        </form>
    </div>    
</body>
</html>