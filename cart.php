...
if ($products_in_cart) {
    ...
    $stmt = $pdo->prepare('SELECT * FROM ProductsNew WHERE productID IN (' . $array_to_question_marks . ')');
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="quantity">
                        <input type="number" name="quantity-<?=$product['productID']?>" value="<?=$products_in_cart[$product['productID']]?>" min="1" max="<?=$product['productStock']?>" placeholder="Quantity" required>
                    </td>
